...
public class RootsRegistry {
  ...
  public static final RegistryObject<Block> MORTAR = BLOCKS.register("mortar", () -> new MortarBlock(AbstractBlock.Properties.of(Material.CLAY).strength(1.0F)));
  public static final RegistryObject<TileEntityType<MortarTile>> MORTAR_TILE = TILE_ENTITIES.register("mortar", () -> TileEntityType.Builder.of(MortarTile::new,
      RootsRegistry.MORTAR.get()).build(null));
  public static final RegistryObject<Block> ALTAR = BLOCKS.register("altar", () -> new AltarBlock(AbstractBlock.Properties.of(Material.CLAY).strength(1.0F)));
  public static final RegistryObject<TileEntityType<AltarTile>> ALTAR_TILE = TILE_ENTITIES.register("altar", () -> TileEntityType.Builder.of(AltarTile::new,
      RootsRegistry.ALTAR.get()).build(null));
  public static final RegistryObject<Block> BRAZIER = BLOCKS.register("brazier", () -> new BlockBrazier(AbstractBlock.Properties.of(Material.CLAY).strength(1.0F)));
  public static final RegistryObject<TileEntityType<BrazierTile>> BRAZIER_TILE = TILE_ENTITIES.register("brazier", () -> TileEntityType.Builder.of(BrazierTile::new,
      RootsRegistry.BRAZIER.get()).build(null));
  public static final RegistryObject<Block> IMBUER = BLOCKS.register("imbuer", () -> new ImbuerBlock(AbstractBlock.Properties.of(Material.CLAY).strength(1.0F)));
  public static final RegistryObject<TileEntityType<ImbuerTile>> IMBUER_TILE = TILE_ENTITIES.register("imbuer", () -> TileEntityType.Builder.of(ImbuerTile::new,
      RootsRegistry.IMBUER.get()).build(null));
  public static final RegistryObject<Block> MUNDANE_STANDING_STONE = BLOCKS.register("mundane_standing_stone", () -> new MundaneStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<Block> ATTUNED_STANDING_STONE = BLOCKS.register("attuned_standing_stone", () -> new AttunedStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<Block> VACUUM_STANDING_STONE = BLOCKS.register("vacuum_standing_stone", () -> new VacuumStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<VacuumStandingStoneTile>> VACUUM_STANDING_STONE_TILE = TILE_ENTITIES.register("vacuum_standing_stone", () -> TileEntityType.Builder.of(VacuumStandingStoneTile::new, RootsRegistry.VACUUM_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> REPULSOR_STANDING_STONE = BLOCKS.register("repulsor_standing_stone", () -> new RepulsorStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<RepulsorStandingStoneTile>> REPULSOR_STANDING_STONE_TILE = TILE_ENTITIES.register("repulsor_standing_stone", () -> TileEntityType.Builder.of(RepulsorStandingStoneTile::new, RootsRegistry.REPULSOR_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> ACCELERATOR_STANDING_STONE = BLOCKS.register("accelerator_standing_stone", () -> new AcceleratorStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<AcceleratorStandingStoneTile>> ACCELERATOR_STANDING_STONE_TILE = TILE_ENTITIES.register("accelerator_standing_stone", () -> TileEntityType.Builder.of(AcceleratorStandingStoneTile::new, RootsRegistry.ACCELERATOR_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> AESTHETIC_STANDING_STONE = BLOCKS.register("aesthetic_standing_stone", () -> new AestheticStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<AestheticStandingStoneTile>> AESTHETIC_STANDING_STONE_TILE = TILE_ENTITIES.register("aesthetic_standing_stone", () -> TileEntityType.Builder.of(AestheticStandingStoneTile::new, RootsRegistry.AESTHETIC_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> ENTANGLER_STANDING_STONE = BLOCKS.register("entangler_standing_stone", () -> new EntanglerStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<EntanglerStandingStoneTile>> ENTANGLER_STANDING_STONE_TILE = TILE_ENTITIES.register("entangler_standing_stone", () -> TileEntityType.Builder.of(EntanglerStandingStoneTile::new, RootsRegistry.ENTANGLER_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> IGNITER_STANDING_STONE = BLOCKS.register("igniter_standing_stone", () -> new IgniterStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<IgniterStandingStoneTile>> IGNITER_STANDING_STONE_TILE = TILE_ENTITIES.register("igniter_standing_stone", () -> TileEntityType.Builder.of(IgniterStandingStoneTile::new, RootsRegistry.IGNITER_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> GROWER_STANDING_STONE = BLOCKS.register("grower_standing_stone", () -> new GrowerStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<GrowerStandingStoneTile>> GROWER_STANDING_STONE_TILE = TILE_ENTITIES.register("grower_standing_stone", () -> TileEntityType.Builder.of(GrowerStandingStoneTile::new, RootsRegistry.GROWER_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> HEALER_STANDING_STONE = BLOCKS.register("healer_standing_stone", () -> new HealerStandingStoneBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.0F)));
  public static final RegistryObject<TileEntityType<HealerStandingStone>> HEALER_STANDING_STONE_TILE = TILE_ENTITIES.register("healer_standing_stone", () -> TileEntityType.Builder.of(HealerStandingStone::new, RootsRegistry.HEALER_STANDING_STONE.get()).build(null));
  public static final RegistryObject<Block> MIDNIGHT_BLOOM = BLOCKS.register("midnight_bloom", () -> new MidnightBloomBlock(AbstractBlock.Properties.of(Material.PLANT)));
  public static final RegistryObject<Block> FLARE_ORCHID = BLOCKS.register("flare_orchid", () -> new FlareOrchidBlock(AbstractBlock.Properties.of(Material.PLANT)));
  public static final RegistryObject<Block> RADIANT_DAISY = BLOCKS.register("radiant_daisy", () -> new RadiantDaisyBlock(AbstractBlock.Properties.of(Material.PLANT)));
  /**
   * Items
   */
  ...
  public static final RegistryObject<Item> SYLVAN_HOOD = ITEMS.register("sylvan_hood", () -> new SylvanArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.HEAD, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> SYLVAN_ROBE = ITEMS.register("sylvan_robe", () -> new SylvanArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.CHEST, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> SYLVAN_TUNIC = ITEMS.register("sylvan_tunic", () -> new SylvanArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.LEGS, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> SYLVAN_BOOTS = ITEMS.register("sylvan_boots", () -> new SylvanArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.FEET, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> WILDWOOD_MASK = ITEMS.register("wildwood_mask", () -> new WildwoodArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.HEAD, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> WILDWOOD_PLATE = ITEMS.register("wildwood_plate", () -> new WildwoodArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.CHEST, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> WILDWOOD_LEGGINGS = ITEMS.register("wildwood_leggings", () -> new WildwoodArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.LEGS, itemBuilder().tab(Roots.tab)));
  public static final RegistryObject<Item> WILDWOOD_BOOTS = ITEMS.register("wildwood_boots", () -> new WildwoodArmorItem(RootsArmorMaterial.SYLVAN, EquipmentSlotType.FEET, itemBuilder().tab(Roots.tab)));
  ...
  public static final RegistryObject<Item> ROOTY_STEW = ITEMS.register("rooty_stew", () -> new SoupItem(itemBuilder().stacksTo(1).food(RootsFoods.ROOTY_STEW).tab(Roots.tab)));
  public static final RegistryObject<Item> FRUIT_SALAD = ITEMS.register("fruit_salad", () -> new SoupItem(itemBuilder().stacksTo(1).food(RootsFoods.FRUIT_SALAD).tab(Roots.tab)));
