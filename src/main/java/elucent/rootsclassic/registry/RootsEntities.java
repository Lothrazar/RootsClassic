...
public class RootsEntities {
	...
	public static final RegistryObject<EntityType<PhantomSkeletonEntity>> PHANTOM_SKELETON = ENTITIES.register("phantom_skeleton", () ->
			register("phantom_skeleton", EntityType.Builder.<PhantomSkeletonEntity>create(PhantomSkeletonEntity::new, EntityClassification.MONSTER)
	...
	public static final RegistryObject<EntityType<EntityAccelerator>> ENTITY_ACCELERATOR = ENTITIES.register("entity_accelerator", () ->
			register("entity_accelerator", EntityType.Builder.<EntityAccelerator>create(EntityAccelerator::new, EntityClassification.MISC)
	...
	public static final RegistryObject<EntityType<EntityTileAccelerator>> TILE_ACCELERATOR = ENTITIES.register("tile_accelerator", () ->
			register("tile_accelerator", EntityType.Builder.<EntityTileAccelerator>create(EntityTileAccelerator::new, EntityClassification.MISC)
					.size(0.5F, 0.5F).trackingRange(64).updateInterval(20).setShouldReceiveVelocityUpdates(true)));
