...
public class RootsFoods {
  ...
  public static final FoodProperties ROOTY_STEW = (new FoodProperties.Builder()).nutrition(7).saturationModifier(0.2F + COOKED_BEEF_SATURATION).build();
  public static final FoodProperties FRUIT_SALAD = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.1F + COOKED_BEEF_SATURATION).build();
}
