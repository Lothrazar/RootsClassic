...
import elucent.rootsclassic.ritual.rituals.RitualEngravedCrafting;
...
public class RitualRegistry {
	...
	public static final RegistryObject<RitualEffect> ENGRAVED_CRAFTING = RITUALS.register("engraved_crafting", RitualEngravedCrafting::new);
