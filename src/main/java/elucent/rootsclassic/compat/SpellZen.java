...
//   */
//  @Method
//  public void setSpellIngredients(Identifier name, IItemStack[] ingredients) {
...
//		Identifier id = Identifier.fromNamespaceAndPath("crafttweaker", uniqueName);
//    CraftTweakerAPI.apply(new ActionAddRecipe<>(INSTANCE, new RecipeHolder<>(id, craftingRecipe)));
//  }
//
//  private RecipeHolder<ComponentRecipe> findSpellByName(Identifier name) {
