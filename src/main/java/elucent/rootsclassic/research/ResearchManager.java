  ...
  public static void reload(RecipeMap recipeMap) {
    ...
    globalResearches.add(new ResearchGroup("ritual", "Rituals")
        ...
        .addResearch(new ResearchBase("engraved_blade", new ItemStack(RootsRegistry.ENGRAVED_BLADE.get()))
            ...
            .addPageOf(RitualRegistry.recipeByName(recipeMap, Const.modLoc("ritual/crafting/engraved_crafting")))
            .addPage(new ResearchPage()
            ...
            .addPage(new ResearchPage()
                .addDisplayItem(new ItemStack(RootsRegistry.PALE_OAK_BARK.get())))
            .addPage(new ResearchPage()
                .addDisplayItem(new ItemStack(RootsRegistry.MANGROVE_BARK.get())))
            .addPage(new ResearchPage()
                .addDisplayItem(new ItemStack(RootsRegistry.CHERRY_BARK.get()))))
