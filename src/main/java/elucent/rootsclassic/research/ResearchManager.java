  ...
  public static void init() {
    ...
    globalResearches.add(new ResearchGroup("nature", "Natural Arts")
        .addResearch(new ResearchBase("barkharvesting", new ItemStack(RegistryManager.druidKnife))
            .addPage(new ResearchPage()
                .addCraftingRecipe(ItemStack.EMPTY, new ItemStack(Blocks.SAPLING), new ItemStack(Blocks.SAPLING), new ItemStack(Blocks.SAPLING), new ItemStack(Blocks.PLANKS), new ItemStack(Blocks.SAPLING), new ItemStack(Items.STICK), new ItemStack(Blocks.SAPLING), ItemStack.EMPTY, new ItemStack(RegistryManager.druidKnife))))
        ...
        .addResearch(new ResearchBase("grassseeds", new ItemStack(RegistryManager.growthSalve))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(RegistryManager.pestle), new ItemStack(Blocks.TALLGRASS, 1, 1), ItemStack.EMPTY, new ItemStack(Items.WHEAT_SEEDS), new ItemStack(Items.REDSTONE), ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, new ItemStack(RegistryManager.growthSalve, 4))))
        .addResearch(new ResearchBase("mutagen", new ItemStack(RegistryManager.mutagen))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(RegistryManager.pestle), new ItemStack(RegistryManager.growthSalve), new ItemStack(RegistryManager.growthSalve), ItemStack.EMPTY, new ItemStack(RegistryManager.growthSalve), new ItemStack(RegistryManager.growthSalve), ItemStack.EMPTY, new ItemStack(Items.NETHER_STAR), new ItemStack(Items.NETHER_WART), new ItemStack(RegistryManager.mutagen))))
        ...
        .addResearch(new ResearchBase("stew", new ItemStack(RegistryManager.rootyStew))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(Items.BOWL), new ItemStack(Items.WHEAT), ItemStack.EMPTY, new ItemStack(RegistryManager.oldRoot), ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, new ItemStack(RegistryManager.rootyStew))))
        .addResearch(new ResearchBase("poultice", new ItemStack(RegistryManager.healingPoultice))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(RegistryManager.pestle), new ItemStack(Items.DYE, 1, 1), ItemStack.EMPTY, new ItemStack(RegistryManager.verdantSprig), new ItemStack(Items.PAPER), ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, new ItemStack(RegistryManager.healingPoultice, 2)))));
    ...
    globalResearches.add(new ResearchGroup("spells", "Spellcraft")
        .addResearch(new ResearchBase("mortar", new ItemStack(RegistryManager.mortar))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(Blocks.STONE), ItemStack.EMPTY, new ItemStack(Blocks.STONE), new ItemStack(Blocks.STONE), ItemStack.EMPTY, new ItemStack(Blocks.STONE), ItemStack.EMPTY, new ItemStack(Blocks.STONE), ItemStack.EMPTY, new ItemStack(RegistryManager.mortar)))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(Blocks.STONE, 1, 3), ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, new ItemStack(Blocks.STONE, 1, 3), new ItemStack(Blocks.STONE, 1, 3), ItemStack.EMPTY, new ItemStack(Blocks.STONE, 1, 3), new ItemStack(Blocks.STONE, 1, 3), new ItemStack(RegistryManager.pestle)))
            .addPage(new ResearchPage()))
        .addResearch(new ResearchBase("imbuer", new ItemStack(RegistryManager.imbuer))
            .addPage(new ResearchPage()
                .addCraftingRecipe(ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, new ItemStack(Items.STICK), ItemStack.EMPTY, new ItemStack(Items.STICK), new ItemStack(Blocks.LOG), new ItemStack(Blocks.STONEBRICK, 1, 3), new ItemStack(Blocks.LOG), new ItemStack(RegistryManager.imbuer)))
            .addPage(new ResearchPage()))
    ...
    globalResearches.add(new ResearchGroup("ritual", "Rituals")
        .addResearch(new ResearchBase("ritual", new ItemStack(RegistryManager.altar))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(RegistryManager.verdantSprig), new ItemStack(Blocks.RED_FLOWER), new ItemStack(RegistryManager.verdantSprig), new ItemStack(Blocks.STONE), new ItemStack(Blocks.GOLD_BLOCK), new ItemStack(Blocks.STONE), ItemStack.EMPTY, new ItemStack(Blocks.STONEBRICK, 1, 3), ItemStack.EMPTY, new ItemStack(RegistryManager.altar)))
            .addPage(new ResearchPage()
                .addCraftingRecipe(new ItemStack(Items.IRON_INGOT), new ItemStack(Items.STRING), new ItemStack(Items.IRON_INGOT), new ItemStack(Items.IRON_INGOT), new ItemStack(Items.CAULDRON), new ItemStack(Items.IRON_INGOT), new ItemStack(Items.IRON_INGOT), ItemStack.EMPTY, new ItemStack(Items.IRON_INGOT), new ItemStack(RegistryManager.brazier)))
            .addPage(new ResearchPage()))
