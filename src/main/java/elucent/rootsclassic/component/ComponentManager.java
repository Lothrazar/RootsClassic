...
public class ComponentManager {
  ...
  public static void reload() {
    ...
    components.add(new ComponentPeony().setPrimaryColor(255, 102, 178).setSecondaryColor(255, 51, 153).setTextColor(ChatFormatting.LIGHT_PURPLE));
    ...
    components.add(new ComponentBlueOrchid().setPrimaryColor(68, 39, 26).setSecondaryColor(162, 153, 150).setTextColor(ChatFormatting.GRAY));
    ...
    components.add(new ComponentApple().setPrimaryColor(255, 43, 89).setSecondaryColor(255, 43, 43).setTextColor(ChatFormatting.DARK_RED));
    components.add(new ComponentMidnightBloom().setPrimaryColor(12, 6, 36).setSecondaryColor(18, 18, 18).setTextColor(ChatFormatting.DARK_PURPLE));
    components.add(new ComponentFlareOrchid().setPrimaryColor(255, 60, 18).setSecondaryColor(255, 60, 18).setTextColor(ChatFormatting.RED));
    components.add(new ComponentRadiantDaisy().setPrimaryColor(255, 255, 255).setSecondaryColor(255, 255, 255).setTextColor(ChatFormatting.WHITE));
  }
