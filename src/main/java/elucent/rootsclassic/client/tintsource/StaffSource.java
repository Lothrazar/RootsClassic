...
public record StaffSource(int tintIndex) implements ItemTintSource {
  public static final MapCodec<StaffSource> MAP_CODEC = RecordCodecBuilder.mapCodec(
    inst -> inst.group(
      Codec.intRange(0, 1).fieldOf("tintIndex").forGetter(StaffSource::tintIndex)
    ).apply(inst, StaffSource::new)
  );
