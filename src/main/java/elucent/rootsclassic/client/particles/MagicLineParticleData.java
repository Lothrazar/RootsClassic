...
public class MagicLineParticleData implements ParticleProvider<MagicParticleTypeData> {
  ...
  public Particle createParticle(MagicParticleTypeData data, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
    return new MagicLineParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, data.color.getRed(), data.color.getGreen(), data.color.getBlue(), this.spriteSet);
  }
  ...
  public static ParticleOptions createData(ParticleColor color) {
	...
	public static ParticleOptions createData(double r, double g, double b) {
		return new MagicParticleTypeData(ParticleRegistry.MAGIC_LINE_TYPE.get(), new ParticleColor(r, g, b, 1.0D));
	}

	public static ParticleOptions createData(double r, double g, double b, double a) {
		return new MagicParticleTypeData(ParticleRegistry.MAGIC_LINE_TYPE.get(), new ParticleColor(r, g, b, a));
	}
}
