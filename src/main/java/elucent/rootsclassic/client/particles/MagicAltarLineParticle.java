...
public class MagicAltarLineParticle extends TextureSheetParticle {
  ...
  public MagicAltarLineParticle(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz, double r, double g, double b, SpriteSet sprite) {
