...
public class BlockAestheticStandingStone extends TEBlockBase implements ITileEntityProvider {
	public static final PropertyEnum topState = PropertyEnum.create("topq", BlockAestheticStandingStone.isTop.class);
	...
	public BlockAestheticStandingStone(){
		super(Material.ROCK);
		setUnlocalizedName("standingStoneAesthetic");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		if (meta == 1){
			return new TileEntityAestheticStandingStone();
		}
		return null;
	}
}
